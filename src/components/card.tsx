  ...
  return (
    <>
      {size === 1 ? (
        ...
        >
          <div className="rounded-3xl bg-stone-700 w-full h-full shadow-[inset_0px_0px_8px_rgba(0,0,0,0.4)] p-10">j</div>
          <DraggableDiv
            visible={visible}
        ...
        >
          ...
          <p className="font-extrabold text-stone-600">
            ...
            similique, quaerat nesciunt labore! Delectus hic iure earum corporis
            distinctio et! Nisi aliquam quod eius, maiores quos totam accusamus
            hic! Pariatur, nemo eaque, libero omnis est quae quia harum sunt
            mollitia explicabo, minima sit culpa nulla unde. Eligendi qui in
            earum.
          </p>
          <DraggableDiv
            visible={visible}
